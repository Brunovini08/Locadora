        ...
        do
        {
            ...
            switch (op)
            {
                case 1:
                    ...
                    decimal diaria = InputHelper.LerDecimal("Digite o valor da diária da categoria: ",
                        "Valor da diária inválida.");
                    string? descricao = InputHelper.LerStringNulo("Digite a descrição da categoria (opcional): ",
                        "Descrição inválida", true);
                ...
                case 4:
                    ...
                    decimal diariaAlterar = InputHelper.LerDecimal("Digite o valor da diária atualizada: ",
